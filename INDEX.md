...
| **[[projects/trinity-consortium/FILE_TREE|FILE_TREE]].md (auto)**               | `scripts/generate-file-tree.py` · refreshed by `scripts/update-tree-map.sh` on commit/checkout · force: `scripts/refresh-repo-maps.sh` · **gitignored** — regenerate locally after clone                     |
