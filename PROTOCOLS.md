...
8. **FRACTAL E8-SSII-AGI / Trinity mirror** — verify `home/projects/trinity-consortium/` table in `INDEX.md` matches engines on disk; `docs/DOME-HUB-ARCHITECTURE.md` Appendix A lists mirror paths (not `python/lava/` at repo root)
...
- Any new neuromorphic engine must be added to `docs/DOME-HUB-ARCHITECTURE.md`
...
- `home/projects/trinity-consortium/skills/INDEX.md`
- `home/projects/trinity-consortium/.agents/skills/INDEX.md`
- `home/projects/trinity-consortium/agents/skills/INDEX.md`
- `home/projects/trinity-consortium/docs/skills/INDEX.md`
- `home/projects/trinity-consortium/server/ai/swarm/skills-library.ts` (production runtime registry)
- `home/projects/trinity-consortium/server/ai/swarm/skill-specs.json` (auto-generated)
