...
class ClaudeRunner:
    ...
    def system_prompt(self) -> str:
        ...
        parts = [
            "You are Claude, running inside DSH — a sovereign, local-first AI ",
            ...
            "capabilities or DSH's architecture.",
            "",
...
def main() -> int:
    p = argparse.ArgumentParser(description="Run Claude locally from DSH.")
