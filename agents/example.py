"""
DSH Agent Stack — Usage Examples
"""

import os, sys

sys.path.insert(0, os.environ.get("DOME_ROOT", os.path.expanduser("~/DSH")))
...
steps = SKILLS["plan"](planner, "Build a REST API for the DSH knowledge base")
for step in steps:
    print(step)
