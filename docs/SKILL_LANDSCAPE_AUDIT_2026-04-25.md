...
>
> **Mirrored at:** `~/DOME-HUB/docs/SKILL_LANDSCAPE_AUDIT_2026-04-25.md` and `~/trinity-unified-ai/reports/SKILL_LANDSCAPE_AUDIT_2026-04-25.md`. Both files are byte-identical.
...
| Project repos surveyed | 4 (`AI_AGENTS/cto-build-framework`, `trinity-consortium`, `trinity-unified-ai`, `DOME-HUB`) + standalone `~/projects/use-railway` |
...
| Skills with divergent SHAs across mirrors | **4** (`dev-auditor`, `trinity-repo-navigator`, `use-railway`, `sacred-geometry-agents`) |
| Trinity ecosystem orphans (single location) | **3** (`mempalace`, `archive-manager`, `find-skills`) |
...
4. **`sacred-geometry-agents` has 4 versions** across main / agents / references / docs tiers.
...
- Skill count: **8** — `verification-validation`, `trinity-coding-standards`, `sacred-geometry-agents`, `end-to-end-wiring`, `v2`, `design-architect`, `trinity-repo-navigator`, `sacred-geometry-expert`
...
#### `~/trinity-unified-ai`
- Multiple skill homes:
  - `skills/` — **39** (mirrors trinity-consortium/skills, mostly in sync) — registry: `skills/INDEX.md`
  - `agents/skills/` — **10** — includes the unique `mempalace` skill
  - `knowledge-base/cto-build/skills/` — **2** embedded copies
  - `knowledge-base/cto-build-framework/skills/` — **2** embedded copies
  - `knowledge-base/trinity-consortium-docs/skills/` — **4** doc-mirror
...
|---|---|---|
| **ai-cost-optimizer** | trinity-consortium/skills/v2, trinity-unified-ai/skills/v2 | 1 SHA (synced) |
| **api-gateway-designer** | trinity-consortium/skills/v2, trinity-unified-ai/skills/v2 | 1 SHA |
| **archive-manager** | trinity-consortium/skills | 1 SHA — **ORPHAN** |
| **ci-cd-architect** | trinity-consortium/skills/v2, trinity-unified-ai/skills/v2 | 1 SHA |
...
| **database-optimizer** | trinity-consortium/skills/v2, trinity-unified-ai/skills/v2 | 1 SHA |
| **deep-research** | trinity-consortium/skills/v2, trinity-unified-ai/skills/v2 | 1 SHA |
| **dependency-manager** | trinity-consortium/skills/v2, trinity-unified-ai/skills/v2 | 1 SHA |
| **dev-auditor** | AI_AGENTS source, trinity-consortium/skills/cto-build, trinity-unified-ai/knowledge-base x2 | **2 SHAs** ⚠️ |
| **design-architect** | .unified-ai/skills | 1 SHA |
| **documentation-generator** | trinity-consortium/skills/v2, trinity-unified-ai/skills/v2 | 1 SHA |
| **end-to-end-wiring** | trinity-consortium/skills/kimi, trinity-unified-ai/skills/kimi | 1 SHA |
| **find-skills** | .agents | 1 SHA — **ORPHAN** (tool-specific) |
| **gh-address-comments** | trinity-consortium/skills/github, trinity-unified-ai/skills/github, .codex | 1 SHA |
| **gh-fix-ci** | same locations | 1 SHA |
| **god-mode** | 5+ locations across main + agents + .agents tiers | Tier-aligned: **3 SHAs by tier** |
| **kb-architecture** | trinity-consortium/agents/skills, trinity-unified-ai/skills, trinity-unified-ai/agents/skills | 1 SHA |
| **knowledge-management** | trinity-consortium/skills/v2, trinity-unified-ai/skills/v2 | 1 SHA |
| **mempalace** | trinity-unified-ai/agents/skills | 1 SHA — **ORPHAN** |
| **migration-specialist** | trinity-consortium/skills/v2, trinity-unified-ai/skills/v2 | 1 SHA |
| **notion-knowledge-capture** | trinity-consortium/skills/integrations/notion, trinity-unified-ai/skills/integrations/notion | 1 SHA |
| **notion-meeting-intelligence** | same | 1 SHA |
| **notion-research-documentation** | same | 1 SHA |
| **notion-spec-to-implementation** | same | 1 SHA |
| **pdf** | trinity-consortium/skills/utility, trinity-unified-ai/skills/utility | 1 SHA |
| **performance-tuner** | trinity-consortium/skills/v2, trinity-unified-ai/skills/v2 | 1 SHA |
| **react-component-architect** | same | 1 SHA |
| **refactoring-engineer** | same | 1 SHA |
| **sacred-geometry** | trinity-consortium/skills, trinity-unified-ai/skills | 1 SHA |
| **sacred-geometry-agents** | 7 locations across main + agents + .agents + docs + KB | **4 SHAs by tier** ⚠️ |
| **sacred-geometry-expert** | .unified-ai/skills | 1 SHA — single-location |
...
| **unified-ai** | trinity-consortium/agents/skills, .agents, trinity-unified-ai/agents/skills | **2 SHAs** |
| **unified-ai-audit** | trinity-consortium/skills, trinity-unified-ai/skills, .codex/.cursor/.openclaw mirrors | 1 SHA |
...
| **womb-3d** | trinity-consortium/skills, trinity-unified-ai/skills | 1 SHA |
| **womb-3d-sacred-geometry** | same | 1 SHA |
...
| `9e8ea601690c...` | `trinity-consortium/skills/cto-build/skills/dev-auditor/SKILL.md`, `.codex/.cursor/.openclaw` mirrors |
...
|---|---|---|
| `cde4a45a1f65...` | main-tree | `trinity-consortium/skills/trinity-repo-navigator/SKILL.md` |
| `6df65e762edd...` | kimi-tier | `trinity-consortium/skills/kimi/trinity-repo-navigator/SKILL.md`, `trinity-unified-ai/skills/kimi/...` |
| `ec471656d87e...` | agents-tier (consortium) | `trinity-consortium/agents/skills/trinity-repo-navigator/SKILL.md` |
| `25eef074893c...` | .agents legacy | `trinity-consortium/.agents/skills/trinity-repo-navigator/SKILL.md` |
| `cfb35ae33b65...` | docs-tier + agents/unified-ai | `trinity-consortium/docs/skills/...`, `trinity-unified-ai/agents/skills/...`, `trinity-unified-ai/knowledge-base/trinity-consortium-docs/skills/...` |
...
- main-tree: canonical = `trinity-consortium/skills/...`
- kimi-tier: keep separate (already 1 SHA across mirrors)
- agents-tier: canonical = `trinity-consortium/agents/skills/...` (most recent updated 2026-04-25)
...
| `fd63cd3680f4...` | main-tree | `trinity-consortium/skills/use-railway/SKILL.md`, `trinity-unified-ai/skills/use-railway/SKILL.md` |
| `b638f75434e3...` | utility-nested | `trinity-consortium/skills/utility/use-railway/SKILL.md`, `trinity-unified-ai/skills/utility/use-railway/SKILL.md` |
| `bf9ea7082e81...` | .agents legacy | `trinity-consortium/.agents/skills/use-railway/SKILL.md` |
...
### 4.4 — `sacred-geometry-agents` (4 SHAs)

| SHA12 | Tier | Locations |
|---|---|---|
| `ac1d3afd772b...` | main-tree | `trinity-consortium/skills/sacred-geometry-agents/SKILL.md`, `trinity-unified-ai/skills/...` |
| `9b9396d030be...` | agents-tier (consortium) + docs | `trinity-consortium/agents/skills/...`, `trinity-consortium/docs/skills/...`, `trinity-unified-ai/knowledge-base/trinity-consortium-docs/skills/...` |
| `56172d49d834...` | .agents legacy | `trinity-consortium/.agents/skills/sacred-geometry-agents/SKILL.md` |
| `80f1c54536e2...` | references sub-skill | `*/sacred-geometry-agents/references/SKILL.md` (sub-skill, identical SHA across all locations) |
...
|---|---|---|
| `mempalace` | `~/trinity-unified-ai/agents/skills/mempalace/SKILL.md` | Keep as unified-ai-only (memory-palace internal feature). Add to unified-ai INDEX. |
| `archive-manager` | `~/projects/trinity-consortium/skills/archive-manager/SKILL.md` | Keep in consortium main-tree only. Register in `skills/INDEX.md`. |
| `find-skills` | `~/.agents/skills/find-skills/SKILL.md` | Tool-specific to `.agents`. Document, don't promote. |
| `sacred-geometry-expert` | `~/.unified-ai/skills/sacred-geometry-expert/SKILL.md` | Single-location. Add to unified-ai INDEX. |
...
### `~/projects/trinity-consortium/skills/INDEX.md` is missing:
- `archive-manager`
...
### `~/projects/trinity-consortium/agents/skills/INDEX.md` is missing:
- `unified-ai`
- `sacred-geometry-agents/references` (sub-skill — borderline; arguably implicit)
...
### `~/projects/trinity-consortium/docs/skills/` has NO INDEX.md
...
- `sacred-geometry-agents`: already mostly tier-aligned; deprecate `.agents/skills/` mirror in Phase 6
...
- `.unified-ai/skills/`
- `trinity-consortium/.agents/skills/` (legacy, but for parity)
- `trinity-consortium/docs/skills/` (reference copy)
...
Run `~/projects/trinity-consortium/scripts/sync-skills.sh` (created in Phase 5) periodically to detect drift.
...
trinity-consortium:           70 SKILL.md
trinity-unified-ai:          113 SKILL.md
DOME-HUB:                     16 SKILL.md
