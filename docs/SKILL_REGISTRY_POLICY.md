...
- Canonical → DSH tiers (`DSH/agents/skills/...`, `DSH/home/.unified-ai/skills/...`, etc.)
...
- Audit: `~/DSH/docs/SKILL_LANDSCAPE_AUDIT_2026-04-25.md` (also at `~/trinity-unified-ai/reports/`)
