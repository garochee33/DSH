...
#   - Branding: dome-console → dsh-console, DOME-HUB → DSH
...
echo "  [2/4] Swapping branding (DOME-HUB → DSH, dome-console → dsh-console)..."
...
echo "    ✓ Paths: DOME-HUB → DSH, dome.db → dsh.db, port 3737 → 4747"
