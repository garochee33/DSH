...
| **Public export (DSH)** | `../docs/PUBLIC_PROD_HARDENING.md` — P0–P3 gap list; DSH vs DSH reconciliation |
...
└── trinity-unified-ai/        ← Trinity Consortium KB API (10,918 docs, 32 engines)
    ...
    ├── BRIDGE.md              ← DSH ↔ Trinity bridge spec
...
- `docs/DSH-ARCHITECTURE.md` §3 (includes **Trinity mirror** table)
