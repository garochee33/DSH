...
- **Surface in DSH:** Cowork mode (desktop app) + Claude Agent SDK + Claude Code
...
- **Role in DSH:** Secondary AI assistant alongside Kiro — focused on document generation,
...
- Read/Write/Edit tools with access to the DSH workspace folder
...
## DSH Integration
- Root: `~/DSH` (host) · `/sessions/.../mnt/DSH` (sandbox mount)
- Workspace folder for user-visible deliverables: `DSH/` root and subfolders
