...
# GPG key is optional — DSH supports both GPG+pass and macOS Keychain for secrets.
...
log "❌ Failed:  $FAIL"
log ""
[ $FAIL -eq 0 ] && log "🟢 DSH PROTOCOLS: ALL GREEN" || log "🔴 DSH PROTOCOLS: $FAIL ISSUE(S) REQUIRE MANUAL ACTION"
log "Log: $LOG"
