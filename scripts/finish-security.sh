...
# Run once: bash /Users/gadikedoshim/DOME-HUB/scripts/finish-security.sh
...
sudo mdutil -i off /Users/gadikedoshim/DOME-HUB 2>/dev/null || true
...
bash /Users/gadikedoshim/DOME-HUB/scripts/audit.sh
