...
def register_agents(conn):
    agents = [
        ...
        {"name": "trinity", "vendor": "trinity-consortium", "version": "portal-1.0", "surface": "api", "role": "ecosystem-bridge", "kb_path": "kb/trinity-unified-ai", "entrypoint": "agents/trinity/runner.py"},
...
def register_kb_skills(conn):
    skills = [
        ...
        {"name": "sacred_geometry", "agent": "framework", "description": "E8 lattice, Platonic solids, φ, Flower of Life, Merkaba", "path": "kb/skills/sacred_geometry/SKILL.md"},
        ...
        {"name": "paradise-estate-mykonos", "agent": "kiro", "description": "Paradise Estate operations", "path": "home/.kiro/skills/paradise-estate-mykonos/SKILL.md"},
        {"name": "ui-ux-pro-max", "agent": "kiro", "description": "AI-powered design intelligence", "path": "home/.kiro/skills/ui-ux-pro-max/SKILL.md"},
        {"name": "sexyverse-designer", "agent": "kiro", "description": "S3XYVERSE frontend design", "path": "home/.kiro/skills/sexyverse-designer/SKILL.md"},
