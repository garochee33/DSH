...
# ── 13. DSH directory structure
echo "==> Creating DSH structure..."
...
cat > "$HOOK" <<'HOOK_EOF'
#!/bin/bash
echo "==> DSH pre-push protocol check..."
