...
def build_stack_block() -> str:
    ...
    lines.append("bash scripts/fractalmap-generate.sh dome-hub")
    lines.append("python3 scripts/generate-file-tree.py --repo dome-hub")
...
def sync_tree_map() -> bool:
    ...
    if dirs and files:
        ...
        content = re.sub(
            r"(Complete inventory of `~/DOME-HUB/` \(24 directories \+ 19 root files\)\.)",
