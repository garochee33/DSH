#!/usr/bin/env python3
"""Benchmark the DOME-HUB local-first voice pipeline.
...
def _print_summary(report: dict[str, Any]) -> None:
    ...
    first = report["runs"][0]
    print("\n" + "=" * 72)
    print(f"{'DOME-HUB Voice Benchmark':<34} {report['audio']['path']}")
    print("-" * 72)
...
def main() -> int:
    parser = argparse.ArgumentParser(description="DOME-HUB Voice Benchmark")
